...
(function ($) {
    ...
    versionSelect.on('change', function () {
        ...
        if (this.value === 'dark') {
            //jQuery(".nav-header .logo-abbr").attr("src", "static/jobie/images/logo-white.png");
            jQuery(".nav-header .logo-compact").attr("src", "static/jobie/images/logo-text-white.html");
            jQuery(".nav-header .brand-title").attr("src", "static/jobie/images/logo-text-white.html");

            setCookie('logo_src', 'static/jobie/images/logo-white.html');
            setCookie('logo_src2', 'static/jobie/images/logo-text-white.html');
        } else {
            jQuery(".nav-header .logo-abbr").attr("src", "static/jobie/images/logo.html");
            jQuery(".nav-header .logo-compact").attr("src", "static/jobie/images/logo-text.html");
            jQuery(".nav-header .brand-title").attr("src", "static/jobie/images/logo-text.html");

            setCookie('logo_src', 'static/jobie/images/logo.html');
            setCookie('logo_src2', 'static/jobie/images/logo-text.html');
        }
    ...
    /* jQuery("#nav_header_color_1").on('click',function(){
        jQuery(".nav-header .logo-abbr").attr("src", "static/jobie/images/logo.png");
        setCookie('logo_src', 'static/jobie/images/logo.png');
        return false;
    }); */
    ...
    /* jQuery("#sidebar_color_2, #sidebar_color_3, #sidebar_color_4, #sidebar_color_5, #sidebar_color_6, #sidebar_color_7, #sidebar_color_8, #sidebar_color_9, #sidebar_color_10, #sidebar_color_11, #sidebar_color_12, #sidebar_color_13, #sidebar_color_14, #sidebar_color_15").on('click',function(){
        jQuery(".nav-header .logo-abbr").attr("src", "static/jobie/images/logo-white.png");
        jQuery(".nav-header .brand-title").attr("src", "static/jobie/images/logo-text-white.png");
        setCookie('logo_src', 'static/jobie/images/logo-white.png');
        return false;
    }); */
